...
void COsoyooTest::Init(TConfigurationNode& t_node) {
   /*
    ...
    * file at the <controllers><osoyoo_test><actuators> and
    * <controllers><osoyoo_test><sensors> sections. If you forgot to
...
// void COsoyooTest::LogLightReadings() const {
...
// void COsoyooTest::LogGroundSensorReadings() const {
...
// void COsoyooTest::LogLidarSensorReadings() const {
...
void COsoyooTest::TestIMUSensor() {
   LOG << CCI_Controller::GetId() << "> IMU: " << std::endl;
   const auto& reading = m_pcIMU->GetReading();
   LOG << "IMU readings: " << std::endl;
   // for(const auto& reading : readings) {
      // LOG <<  " - " << reading << std::endl;
   // }
   LOG << " - pitch: " << reading.Pitch
    << " roll: "  << reading.Roll
    << " yaw: "   << reading.Yaw
    << std::endl;
 ...
 */
REGISTER_CONTROLLER(COsoyooTest, "osoyoo_test_controller")
