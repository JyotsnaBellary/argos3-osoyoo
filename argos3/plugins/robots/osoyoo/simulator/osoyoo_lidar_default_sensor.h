/**
 * @file <argos3/plugins/robots/osoyoo/simulator/osoyoo_lidar_default_sensor.h>
 *
 * @author Carlo Pinciroli - <ilpincy@gmail.com>
 */

#ifndef OSOYOO_LIDAR_DEFAULT_SENSOR_H
#define OSOYOO_LIDAR_DEFAULT_SENSOR_H

#include <string>
#include <map>

namespace argos {
   class COsoyooLIDARDefaultSensor;
}
...
namespace argos {
   ...
   class COsoyooLIDARDefaultSensor : public CCI_OsoyooLIDARSensor,
                                        public CSimulatedSensor {

   public:

      COsoyooLIDARDefaultSensor();

      virtual ~COsoyooLIDARDefaultSensor();
