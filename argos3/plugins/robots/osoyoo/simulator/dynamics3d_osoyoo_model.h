/**
 * @file <osoyoo/simulator/dynamics3d_osoyoo_model.h>
 *
 * @author Michael Allwright - <allsey87@gmail.com>
 */

#ifndef DYNAMICS3D_OSOYOO_MODEL_H
#define DYNAMICS3D_OSOYOO_MODEL_H

namespace argos {
   class CDynamics3DOsoyooModel;
   class COsoyooEntity;
...
namespace argos {
   ...
   class CDynamics3DOsoyooModel : public CDynamics3DMultiBodyObjectModel {

   public:     

      CDynamics3DOsoyooModel(CDynamics3DEngine& c_engine,
                            COsoyooEntity& c_osoyoo);

      virtual ~CDynamics3DOsoyooModel() {}
