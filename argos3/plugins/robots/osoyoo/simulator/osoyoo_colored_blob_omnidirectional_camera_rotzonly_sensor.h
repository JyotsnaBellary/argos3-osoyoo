#ifndef OSOYOO_COLORED_BLOB_OMNIDIRECTIONAL_CAMERA_ROTZONLY_SENSOR_H
#define OSOYOO_COLORED_BLOB_OMNIDIRECTIONAL_CAMERA_ROTZONLY_SENSOR_H

namespace argos {
   class COsoyooColoredBlobOmnidirectionalCameraRotZOnlySensor;
   class COmnidirectionalCameraEquippedEntity;
   class CLEDEntity;
   class CControllableEntity;
   class COsoyooOmnidirectionalCameraLEDCheckOperation;
}
...
namespace argos {
  ...
  class COsoyooColoredBlobOmnidirectionalCameraRotZOnlySensor : public CCI_OsoyooColoredBlobOmnidirectionalCameraSensor,
                                                          public CSimulatedSensor {

   public:

      COsoyooColoredBlobOmnidirectionalCameraRotZOnlySensor();

      virtual ~COsoyooColoredBlobOmnidirectionalCameraRotZOnlySensor();
