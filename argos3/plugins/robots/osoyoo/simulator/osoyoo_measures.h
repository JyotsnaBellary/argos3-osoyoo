...
extern const Real OSOYOO_COLUMN_RADIUS ;      
extern const Real OSOYOO_COLUMN_HEIGHT;
extern const Real OSOYOO_NUM_COLUMNS;
extern const Real OSOYOO_UPPER_BODY_HEIGHT;

extern const Real OSOYOO_WHEEL_RADIUS;
extern const Real OSOYOO_WHEEL_DISTANCE;
extern const Real OSOYOO_HALF_WHEEL_DISTANCE;
