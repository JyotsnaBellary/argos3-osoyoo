#include "osoyoo_colored_blob_omnidirectional_camera_rotzonly_sensor.h"
...
namespace argos {
   ...
   REGISTER_SENSOR(COsoyooColoredBlobOmnidirectionalCameraRotZOnlySensor,
                   "osoyoo_colored_blob_omnidirectional_camera", "rot_z_only",
                   ...
                   "      <sensors>\n"
                   "        ...\n"
                   "        <osoyoo_colored_blob_omnidirectional_camera implementation=\"rot_z_only\"\n"
                   "                                             medium=\"leds\" />\n"
                   "        ...\n"
                   "      </sensors>\n"
                   "      ...\n"
