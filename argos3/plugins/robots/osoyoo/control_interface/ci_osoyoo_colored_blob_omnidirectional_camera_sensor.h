#ifndef CCI_OSOYOO_COLORED_BLOB_OMNIDIRECTIONAL_CAMERA_SENSOR_H
#define CCI_OSOYOO_COLORED_BLOB_OMNIDIRECTIONAL_CAMERA_SENSOR_H

namespace argos {
   class CCI_OsoyooColoredBlobOmnidirectionalCameraSensor;
}
...
namespace argos {
    ...
    */
   class CCI_OsoyooColoredBlobOmnidirectionalCameraSensor: public CCI_Sensor {
   ...
   public:
       ...
       * polar coordinates. The angle is counted counter-clockwise watching the Osoyoo from top, as to respect the
   ...
   public:
       ...
       * Constructor
       */
      CCI_OsoyooColoredBlobOmnidirectionalCameraSensor() {}

      /**
       * Destructor
       */
      virtual ~CCI_OsoyooColoredBlobOmnidirectionalCameraSensor() {}
