/**
 * @file <argos3/plugins/robots/osoyoo/control_interface/ci_osoyoo_encoder_sensor.h>
 *
 * @brief This file provides the definition of the osoyoo encoder sensor. It

 * This file provides the definition of the osoyoo encoder sensor. It
 ...
 * On the osoyoo there is a sensor that, at start-up, measure this distance,
...
#ifndef CCI_OSOYOO_ENCODER_SENSOR_H
#define CCI_OSOYOO_ENCODER_SENSOR_H

/* To avoid dependency problems when including */
namespace argos {
   class CCI_OsoyooEncoderSensor;
}
...
namespace argos {
   ...
   class CCI_OsoyooEncoderSensor : public CCI_Sensor {
   ...
   public:
       ...
       * Destructor
       */
      virtual ~CCI_OsoyooEncoderSensor() {}
