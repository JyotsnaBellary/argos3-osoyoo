/**
 * @file <argos3/plugins/robots/osoyoo/control_interface/ci_osoyoo_imu_sensor.h>
 *
 * @brief This file provides the definition of the OSOYOO IMU sensor.
 *
...
#ifndef CCI_OSOYOO_IMU_SENSOR_H
#define CCI_OSOYOO_IMU_SENSOR_H

namespace argos
{
  class CCI_OSOYOOIMUSensor;
}
...
namespace argos
{
  class CCI_OSOYOOIMUSensor : public CCI_Sensor
  {
  ...
  std::ostream &operator<<(std::ostream &c_os,
                           const CCI_OSOYOOIMUSensor::SReading &s_reading);
}
#endif
