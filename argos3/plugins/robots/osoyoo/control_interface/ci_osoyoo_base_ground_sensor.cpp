...
#include "ci_osoyoo_base_ground_sensor.h"
...
namespace argos {
   ...
   CCI_OsoyooBaseGroundSensor::CCI_OsoyooBaseGroundSensor() :
      m_tReadings(8) {
   ...
   const CCI_OsoyooBaseGroundSensor::TReadings& CCI_OsoyooBaseGroundSensor::GetReadings() const {
     return m_tReadings;
   }
...
#ifdef ARGOS_WITH_LUA
   void CCI_OsoyooBaseGroundSensor::CreateLuaState(lua_State* pt_lua_state) {
...
#ifdef ARGOS_WITH_LUA
   void CCI_OsoyooBaseGroundSensor::ReadingsToLuaState(lua_State* pt_lua_state) {
