#include "ci_osoyoo_colored_blob_omnidirectional_camera_sensor.h"
...
namespace argos
{
   ...
   /****************************************/
      ...
      {
         /* Perform action */
         CLuaUtility::GetDeviceInstance<CCI_OsoyooColoredBlobOmnidirectionalCameraSensor>(pt_lua_state, "osoyoo_colored_blob_omnidirectional_camera")->Enable();
         return 0;
      }
   #endif
      ...
      {
         /* Perform action */
         CLuaUtility::GetDeviceInstance<CCI_OsoyooColoredBlobOmnidirectionalCameraSensor>(pt_lua_state, "osoyoo_colored_blob_omnidirectional_camera")->Disable();
         return 0;
      }
   #endif
   ...
   #ifdef ARGOS_WITH_LUA
      void CCI_OsoyooColoredBlobOmnidirectionalCameraSensor::CreateLuaState(lua_State *pt_lua_state)
      {
         CLuaUtility::OpenRobotStateTable(pt_lua_state, "osoyoo_colored_blob_omnidirectional_camera");
   ...
   #ifdef ARGOS_WITH_LUA
      void CCI_OsoyooColoredBlobOmnidirectionalCameraSensor::ReadingsToLuaState(lua_State *pt_lua_state)
      {
         lua_getfield(pt_lua_state, -1, "osoyoo_colored_blob_omnidirectional_camera");
