/**
 * @file <argos3/plugins/robots/osoyoo/control_interface/ci_osoyoo_base_ground_sensor.h>
 *
 * @brief This file provides the interface of the osoyoo base ground sensor.
 *
...
#ifndef CCI_OSOYOO_BASE_GROUND_SENSOR_H
#define CCI_OSOYOO_BASE_GROUND_SENSOR_H

namespace argos {
   class CCI_OsoyooBaseGroundSensor;
}
...
namespace argos {
   ...
   class CCI_OsoyooBaseGroundSensor : virtual public CCI_Sensor {
   ...
   public:
      ...
      CCI_OsoyooBaseGroundSensor();

      virtual ~CCI_OsoyooBaseGroundSensor() {}
   ...
   std::ostream& operator<<(std::ostream& c_os,
                            const CCI_OsoyooBaseGroundSensor::SReading& s_reading);

   std::ostream& operator<<(std::ostream& c_os,
                            const CCI_OsoyooBaseGroundSensor::TReadings& t_readings);
